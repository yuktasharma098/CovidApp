            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <div className="navbar-nav ms-auto text-center">
                ...
                <li class="nav-item dropdown">
                  <NavLink class="nav-link dropdown-toggle" to="/" id="navbarDropdown" role="button" data-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">
                    Resources
        </NavLink>
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <NavLink class="dropdown-item font-weight-bold" to="/oxygen">Oxygen</NavLink>

                    <NavLink class="dropdown-item font-weight-bold" to="/beds">Hospitals Beds</NavLink>
                    <NavLink class="dropdown-item font-weight-bold" to="/medicine">Medicines</NavLink>
                    <NavLink class="dropdown-item font-weight-bold" to="/">Food</NavLink>
